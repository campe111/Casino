...
var iniciarJuego = function (juego) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, slots, slotsPrem, blackjack, bingo;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = juego;
                switch (_a) {
                    case 'Slots STD': return [3 /*break*/, 1];
                    case 'Slots Premium': return [3 /*break*/, 3];
                    case 'Blackjack': return [3 /*break*/, 5];
                    case 'Bingo': return [3 /*break*/, 7];
                }
                return [3 /*break*/, 9];
            case 1:
                slots = new SlotsSTD_1.SlotsSTD('Slots STD', 'Juego de Casino', 100);
                return [4 /*yield*/, slots.jugar()];
            case 2:
                _b.sent(); // Llama al método jugar() del juego SlotsSTD
                return [3 /*break*/, 10];
            case 3:
                slotsPrem = new SlotsPrem_1.SlotsPrem('Slots Premium', 'Juego de Casino', 100, 5);
                return [4 /*yield*/, slotsPrem.jugar()];
            case 4:
                _b.sent(); // Llama al método jugar() del juego Slots Premium
                return [3 /*break*/, 10];
            case 5:
                blackjack = new BlackJack_1.BlackJack('Blackjack', 'Juego de Casino', 100, 5);
                blackjack.repartirCartas(2); // Reparte las cartas al comenzar el juego
                return [4 /*yield*/, blackjack.jugar()];
            case 6:
                _b.sent(); // Llama al método jugar() del juego Blackjack
                return [3 /*break*/, 10];
            case 7:
                bingo = new Bingo_1.Bingo();
                return [4 /*yield*/, bingo.jugar()];
            case 8:
                _b.sent(); // Llama al método jugar() del juego Bingo
                return [3 /*break*/, 10];
            case 9:
                console.log('Opción no válida.');
                return [3 /*break*/, 10];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = opcion;
                switch (_a) {
                    case 'slotsSTD': return [3 /*break*/, 2];
                    case 'slotsPremium': return [3 /*break*/, 4];
                    case 'blackjack': return [3 /*break*/, 6];
                    case 'bingo': return [3 /*break*/, 8];
                    case 'volver': return [3 /*break*/, 10];
                }
                return [3 /*break*/, 11];
            case 2: return [4 /*yield*/, iniciarJuego('Slots STD')];
            case 3:
                _b.sent();
                return [3 /*break*/, 12];
            case 4: return [4 /*yield*/, iniciarJuego('Slots Premium')];
            case 5:
                _b.sent();
                return [3 /*break*/, 12];
            case 6: return [4 /*yield*/, iniciarJuego('Blackjack')];
            case 7:
                _b.sent(); // Inicia el juego de Blackjack
                return [3 /*break*/, 12];
            case 8: return [4 /*yield*/, iniciarJuego('Bingo')];
            case 9:
                _b.sent();
                return [3 /*break*/, 12];
            case 10:
            ...
            case 11:
                ...
                return [3 /*break*/, 12];
            case 12:
                if (!(opcion !== 'volver')) return [3 /*break*/, 14];
